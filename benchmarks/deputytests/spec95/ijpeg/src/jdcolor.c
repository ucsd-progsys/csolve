...
#define my_cconvert_ptr jdcolor_my_convert_ptr


/* Private subobject */

typedef struct my_color_deconverter {
...
#pragma ccured_extends("Smy_color_deconverter", "Sjpeg_color_deconverter")
...
jinit_color_deconverter (j_decompress_ptr cinfo)
{
  ...
  cconvert =
    (my_cconvert_ptr)alloc_small_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
