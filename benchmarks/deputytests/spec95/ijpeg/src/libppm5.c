...
#if __STDC__
void
ppmd_point_drawproc( pixel** pixels, int cols, int rows, pixval maxval, int x, int y, void* clientdata )
#else /*__STDC__*/
void
...
#if __STDC__
void
ppmd_filledrectangle( pixel** pixels, int cols, int rows, pixval maxval, int x, int y, int width, int height, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata )
#else /*__STDC__*/
void
...
#if __STDC__
void
ppmd_line( pixel** pixels, int cols, int rows, pixval maxval, int x0, int y0, int x1, int y1, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata )
#else /*__STDC__*/
void
...
#if __STDC__
void
ppmd_spline3( pixel** pixels, int cols, int rows, pixval maxval, int x0, int y0, int x1, int y1, int x2, int y2, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata )
#else /*__STDC__*/
void
...
#if __STDC__
void
ppmd_polyspline( pixel** pixels, int cols, int rows, pixval maxval, int x0, int y0, int nc, int* xc, int* yc, int x1, int y1, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata )
#else /*__STDC__*/
void
...
#if __STDC__
void
ppmd_circle( pixel** pixels, int cols, int rows, pixval maxval, int cx, int cy, int radius, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata )
#else /*__STDC__*/
void
...
ppmd_fill_init( )
    ...
    //sm: fh = (fillobj*) malloc( sizeof(fillobj) );
    fh = (fillobj*) malloc( sizeof(*fh) );
    if ( fh == 0 )
	pm_error( "out of memory allocating a fillhandle" );
    fh->n = 0;
    //sm: fh->coords = (coord*) malloc( SOME * sizeof(coord) );
    fh->coords = (coord*) malloc( SOME * sizeof(*(fh->coords)) );
    if ( fh->coords == 0 )
	pm_error( "out of memory allocating a fillhandle" );
    fh->size = SOME;
    fh->curedge = 0;
...
#if __STDC__
void
ppmd_fill_drawproc( pixel** pixels, int cols, int rows, pixval maxval, int x, int y, void* clientdata )
#else /*__STDC__*/
void
ppmd_fill_drawproc( pixels, cols, rows, maxval, x, y, clientdata )
	...
	fh->coords = (coord*) realloc(
            //sm: (char*) fh->coords, fh->size * sizeof(coord) );
	    (char*) fh->coords, fh->size * sizeof(*(fh->coords)) );
	if ( fh->coords == 0 )
...
#if __STDC__
void
ppmd_fill( pixel** pixels, int cols, int rows, pixval maxval,
           void* fillhandle,
           void (*drawprocP)(pixel**, int, int, pixval, int, int, void*),
           void* clientdata )
#else /*__STDC__*/
void
ppmd_fill( pixels, cols, rows, maxval, fillhandle, drawprocP, clientdata )
    ...
    //sm: qsort( (char*) fh->coords, fh->n, sizeof(coord), yx_compare );
    qsort( fh->coords, fh->n, sizeof(*(fh->coords)), yx_compare );
