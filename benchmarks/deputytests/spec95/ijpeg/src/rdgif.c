...
start_input_gif (j_compress_ptr cinfo, cjpeg_source_ptr sinfo)
{
  ...
  source->symbol_head =
    (UINT16 FAR *)alloc_large_wrapper ((j_common_ptr) cinfo, JPOOL_IMAGE,
                                       LZW_TABLE_SIZE * SIZEOF(UINT16));
  source->symbol_tail =
    (UINT8 FAR *)alloc_large_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
...
jinit_read_gif (j_compress_ptr cinfo)
{
  ...
  source =
    (gif_source_ptr)alloc_small_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
