...
#define my_upsample_ptr jdmerge_my_upsample_ptr


/* Private subobject */

typedef struct my_upsampler_merge {
...
typedef my_upsampler_merge * my_upsample_ptr;
#pragma ccured_extends("Smy_upsampler_merge", "Sjpeg_upsampler")
...
jinit_merged_upsampler (j_decompress_ptr cinfo)
{
  ...
  upsample =
    (my_upsample_ptr)alloc_small_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
  ...
  if (cinfo->max_v_samp_factor == 2) {
    ...
    upsample->spare_row =
      (JSAMPROW)alloc_large_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
