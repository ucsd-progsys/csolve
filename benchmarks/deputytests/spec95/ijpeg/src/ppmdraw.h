...
*/
void ppmd_point_drawproc ARGS(( pixel** pixels, int cols, int rows, pixval maxval, int x, int y, void* clientdata ));
/*
...
*/
#if __STDC__
#define PPMD_NULLDRAWPROC (void (*)(pixel**, int, int, pixval, int, int, void*)) 0
#else /*__STDC__*/
...
void ppmd_line ARGS(( pixel** pixels, int cols, int rows, pixval maxval, int x0, int y0, int x1, int y1, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata ));
/* Draws a line from (x0, y0) to (x1, y1).
*/

void ppmd_spline3 ARGS(( pixel** pixels, int cols, int rows, pixval maxval, int x0, int y0, int x1, int y1, int x2, int y2, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata ));
...
void ppmd_polyspline ARGS(( pixel** pixels, int cols, int rows, pixval maxval, int x0, int y0, int nc, int* xc, int* yc, int x1, int y1, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata ));
...
void ppmd_circle ARGS(( pixel** pixels, int cols, int rows, pixval maxval, int cx, int cy, int radius, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata ));
...
void ppmd_filledrectangle ARGS(( pixel** pixels, int cols, int rows, pixval maxval, int x, int y, int width, int height, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata ));
...
void ppmd_fill_drawproc ARGS(( pixel** pixels, int cols, int rows, pixval maxval, int x, int y, void* clientdata ));
/* Use this drawproc to trace the outline you want filled.  Be sure to use
** the fillhandle as the clientdata.
*/

void ppmd_fill ARGS(( pixel** pixels, int cols, int rows, pixval maxval, void* fillhandle, void (*drawprocP)(pixel**, int, int, pixval, int, int, void*), void* clientdata ));
