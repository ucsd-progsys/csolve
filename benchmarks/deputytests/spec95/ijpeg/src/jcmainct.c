...
#define my_main_ptr jcmainct_my_main_ptr


/* Private buffer controller object */

typedef struct my_main_controller {
...
#pragma ccured_extends("Smy_main_controller", "Sjpeg_c_main_controller")
...
jinit_c_main_controller (j_compress_ptr cinfo, boolean need_full_buffer)
{
  ...
  main = (my_main_ptr)alloc_small_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
