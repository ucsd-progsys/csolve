...
void** pm_allocarray ARGS(( int cols, int rows, int size ));
#pragma ccuredpoly("pm_allocarray")
void* pm_allocrow ARGS(( int cols, int size ));
#pragma ccuredpoly("pm_allocrow")
void pm_freearray ARGS(( void** its, int rows ));
#pragma ccuredpoly("pm_freearray")
void pm_freerow ARGS(( void* itrow ));
#pragma ccuredpoly("pm_freerow")
...
#pragma ccuredvararg("pm_message", printf(1))
