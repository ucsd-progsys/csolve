...
#define my_coef_ptr jdcoefct_my_coef_ptr

/* Private buffer controller object */

typedef struct my_coef_controller_d {
...
} my_coef_controller_d;

typedef my_coef_controller_d * my_coef_ptr;

#pragma ccured_extends("Smy_coef_controller_d", "Sjpeg_d_coef_controller")
...
jinit_d_coef_controller (j_decompress_ptr cinfo, boolean need_full_buffer)
{
  ...
  coef =
    (my_coef_ptr)alloc_small_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
  ...
  if (need_full_buffer) {
    ...
    buffer =
      (JBLOCKROW)alloc_large_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
