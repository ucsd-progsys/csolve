...
#define my_master_ptr jdmaster_my_master_ptr
...
typedef struct my_decomp_master {
...
#pragma ccured_extends("Smy_decomp_master", "Sjpeg_decomp_master")
...
/* Allocate and fill in the sample_range_limit table */
{
  ...
  table =
    (JSAMPLE *)alloc_small_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
                                   (5 * (MAXJSAMPLE+1)
...
jinit_master_decompress (j_decompress_ptr cinfo)
{
  ...
  master =
    (my_master_ptr)alloc_small_wrapper ((j_common_ptr) cinfo, JPOOL_IMAGE,
