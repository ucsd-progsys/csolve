...
jinit_write_gif (j_decompress_ptr cinfo)
{
  ...
  dest =
    (gif_dest_ptr)alloc_small_wrapper ((j_common_ptr) cinfo, JPOOL_IMAGE,
  ...
  dest->hash_code =
    (code_int *)alloc_small_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
                                    HSIZE * SIZEOF(code_int));
  dest->hash_value =
    (hash_entry FAR *)alloc_small_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
