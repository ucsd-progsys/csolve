...
#define huff_entropy_ptr jdhuff_huff_entropy_ptr
#define working_state jdhuff_working_state
#define savable_state jdhuff_savable_state
...
typedef struct  huff_entropy_decoder {
...
#pragma ccured_extends("Shuff_entropy_decoder", "Sjpeg_entropy_decoder")
...
/* Compute the derived values for a Huffman table */
{
  ...
  if (*pdtbl == NULL)
    *pdtbl =
      (D_DERIVED_TBL *)alloc_small_wrapper ((j_common_ptr) cinfo, JPOOL_IMAGE,
