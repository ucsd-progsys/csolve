...
#define jpeg_common_fields \
  ...
  struct jpeg_memory_mgr * __RTTI mem;	/* Memory manager module */\
...
struct jpeg_compress_struct {
  ...
  struct jpeg_destination_mgr * __RTTI dest;
   ...
   */
  struct jpeg_comp_master * __RTTI master;
  struct jpeg_c_main_controller * __RTTI main;
  struct jpeg_c_prep_controller * __RTTI prep;
  struct jpeg_c_coef_controller * __RTTI coef;
  struct jpeg_marker_writer * marker;
  struct jpeg_color_converter * __RTTI cconvert;
  struct jpeg_downsampler * __RTTI downsample;
  struct jpeg_forward_dct * __RTTI fdct;
  struct jpeg_entropy_encoder * __RTTI entropy;
};
...
struct jpeg_decompress_struct {
  ...
  struct jpeg_source_mgr * __RTTI src;
   ...
   */
  struct jpeg_decomp_master * __RTTI master;
  struct jpeg_d_main_controller * __RTTI main;
  struct jpeg_d_coef_controller * __RTTI coef;
  struct jpeg_d_post_controller * __RTTI post;
  struct jpeg_marker_reader * marker;
  struct jpeg_entropy_decoder * __RTTI entropy;
  struct jpeg_inverse_dct * __RTTI idct;
  struct jpeg_upsampler * __RTTI upsample;
  struct jpeg_color_deconverter * __RTTI cconvert;
  struct jpeg_color_quantizer * __RTTI cquantize;
};
...
// Some wrappers for the allocators
void *alloc_small_wrapper(j_common_ptr cinfo,
                          int pool_id,
                          size_t sizeofobject);
#pragma ccuredalloc("alloc_small_wrapper", nozero, sizein(3))

void * alloc_large_wrapper(j_common_ptr cinfo, int pool_id,
                           size_t sizeofobject);
#pragma ccuredalloc("alloc_large_wrapper", nozero, sizein(3))
