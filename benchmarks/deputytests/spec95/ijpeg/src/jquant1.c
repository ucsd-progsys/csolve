...
#define my_cquantize_ptr jquant1_my_cquantize_ptr
...
#pragma ccured_extends("Smy_cquantizer1", "Sjpeg_color_quantizer")
...
create_colormap (j_decompress_ptr cinfo)
{
  ...
  if (cinfo->dither_mode == JDITHER_ORDERED) {
    ...
    odither =
      (ODITHER_MATRIX *)alloc_small_wrapper((j_common_ptr) cinfo, JPOOL_IMAGE,
