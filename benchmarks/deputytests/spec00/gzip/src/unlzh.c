...
#ifdef RCSID
static char rcsid[] = "$Id: unlzh.c 8288 2006-06-06 14:18:32Z necula $";
#endif
...
local unsigned  decode  OF((unsigned count, uch * COUNT(count) buffer));
...
local void make_table OF((int nchar, uch * COUNT(nchar) bitlen,
			  int tablebits, ush * COUNT(tablebits) table));
