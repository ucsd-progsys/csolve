...
void Compute_Tree(Root NONNULL r);
Demand Compute_Lateral(Lateral NONNULL l, double theta_R, double theta_I,
                       double pi_R, double pi_I);
Demand Compute_Branch(Branch NONNULL b, double theta_R, double theta_I,
                       double pi_R, double pi_I);
Demand Compute_Leaf(Leaf NONNULL l, double pi_R, double pi_I);
