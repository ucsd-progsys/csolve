...
double find_g ();
double find_h ();
double find_gradient_f (double pi_R, double pi_I, local double* NONNULL COUNT(2) gradient);
double find_gradient_g (local double* NONNULL COUNT(2) gradient);
double find_gradient_h (local double*  NONNULL COUNT(2) gradient);
void find_dd_grad_f (double pi_R, double pi_I, local double* NONNULL COUNT(2) dd_grad);
double make_orthogonal (local double*  NONNULL COUNT(2) v_mod, local double*  NONNULL COUNT(2) v_static);
