...
global int ASSUMECONST nbody;			/* number of bodies in system       */

global bodyptr COUNT(nbody) bodytab;	/* points to array of bodies        */
...
void maketree(bodyptr COUNT(nbody) , int);			/* construct tree structure */
