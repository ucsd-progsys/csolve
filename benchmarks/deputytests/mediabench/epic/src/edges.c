...
void reflect1(float * COUNT(x_dim*y_dim) NONNULL filt,
             int x_dim, int y_dim, int x_pos, int y_pos,
             float * COUNT(x_dim*y_dim) NONNULL result, int f_or_e);
void reflect2(float * COUNT(x_dim*y_dim) NONNULL filt,
             int x_dim, int y_dim, int x_pos, int y_pos,
             float * COUNT(x_dim*y_dim) NONNULL result, int f_or_e);
void repeat(float * COUNT(x_dim*y_dim) NONNULL filt,
           int x_dim, int y_dim, int x_pos, int y_pos,
           float * COUNT(x_dim*y_dim) NONNULL result, int f_or_e);
void extend(float * COUNT(x_dim*y_dim) NONNULL filt,
           int x_dim, int y_dim, int x_pos, int y_pos,
           float * COUNT(x_dim*y_dim) NONNULL result, int f_or_e);
void ereflect(float * COUNT(x_dim*y_dim) NONNULL filt,
             int x_dim, int y_dim, int x_pos, int y_pos,
             float * COUNT(x_dim*y_dim) NONNULL result, int f_or_e);
void predict(float * COUNT(x_dim*y_dim) NONNULL filt,
            int x_dim, int y_dim, int x_pos, int y_pos,
            float * COUNT(x_dim*y_dim) NONNULL result, int f_or_e);
void zero(float * COUNT(x_dim*y_dim) NONNULL filt,
         int x_dim, int y_dim, int x_pos, int y_pos,
         float * COUNT(x_dim*y_dim) NONNULL result, int f_or_e);
void nocompute(float * COUNT(x_dim*y_dim) NONNULL filt,
              int x_dim, int y_dim, int x_pos, int y_pos,
              float * COUNT(x_dim*y_dim) NONNULL result, int f_or_e);
...
void zero(filt,x_dim,y_dim,x_pos,y_pos,result,f_or_e)
...
void repeat(filt,x_dim,y_dim,x_pos,y_pos,result,f_or_e)
  register float *filt, *result;
  register int x_dim;
  int y_dim, x_pos, y_pos, f_or_e;
  {
...
void reflect2(filt,x_dim,y_dim,x_pos,y_pos,result,f_or_e)
  register float *filt, *result;
  register int x_dim;
  int y_dim, x_pos, y_pos, f_or_e;
  {
...
void reflect1(filt,x_dim,y_dim,x_pos,y_pos,result,f_or_e)
  register float *filt, *result;
  register int x_dim;
  int y_dim, x_pos, y_pos, f_or_e;
  {
...
void extend(filt,x_dim,y_dim,x_pos,y_pos,result,f_or_e)
  register float *filt, *result;
  register int x_dim;
  int y_dim, x_pos, y_pos, f_or_e;
  {
...
void nocompute(filt,x_dim,y_dim,x_pos,y_pos,result,f_or_e)
  register float *filt, *result;
  register int x_dim;
  int y_dim, x_pos, y_pos, f_or_e;
  {
...
void ereflect(filt,x_dim,y_dim,x_pos,y_pos,result,f_or_e)
  register float *filt, *result;
  register int x_dim;
  int y_dim, x_pos, y_pos, f_or_e;
  {
...
void predict(filt,x_dim,y_dim,x_pos,y_pos,result,f_or_e)
  register float *filt, *result;
  register int x_dim;
  int y_dim, x_pos, y_pos, f_or_e;
  {
