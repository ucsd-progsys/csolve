...
void parse_epic_args (argc, argv, image, x_size, y_size, 
  ...
  *compression_factor = 20.0;
  ...
  filename = argv[1];
  infile = check_fopen(filename, "rb");
  ...
  *outfile = check_fopen(filename, "wb");
  }
...
void parse_unepic_args(argc, argv, epicfile, num_levels, x_size, y_size, 
  ...
  *epicfile = check_fopen(argv[1], "rb");
