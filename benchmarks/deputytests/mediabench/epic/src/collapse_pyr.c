...
static void internal_int_transpose(int * COUNT(rows*cols) NONNULL mat,
                                   int rows, int cols );
...
void collapse_pyr(pyr, result, x_size, y_size, num_levels)
...
======================================================================
*/
static void internal_int_transpose( mat, rows, cols )
  register int *mat;
  register int cols;
  int rows;
  {
