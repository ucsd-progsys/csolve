...
AllocVCG(void)
{
    ...
    removeVCG = (constraintVCGType * COUNT(channelNets+1) *)malloc((channelNets + 1) * (channelNets + 1) * sizeof(* removeVCG /*constraintVCGType **/));
}
...
void
DFSClearVCG(nodeVCGType * YACR_ARRAY VCG)
{
    ulong	net;
...
void
DumpVCG(nodeVCGType * YACR_ARRAY VCG)
{
    ulong	net;
    ulong	which;
...
void
DFSAboveVCG(nodeVCGType * YACR_ARRAY VCG,
	    ulong net)
{
    ulong	s;
    ulong 	above;
...
void
DFSBelowVCG(nodeVCGType * YACR_ARRAY VCG,
	    ulong net)
{
    ulong	s;
    ulong 	below;
...
void
SCC_DFSAboveVCG(nodeVCGType * YACR_ARRAY VCG,
		ulong net,
		ulong * SAFE label)
{
    ulong	s;
...
void
SCC_DFSBelowVCG(nodeVCGType * YACR_ARRAY VCG,
		ulong net,
		ulong label)
{
    ulong	s;
