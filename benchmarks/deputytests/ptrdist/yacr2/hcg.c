...
void
DFSClearHCG(nodeHCGType * YACR_ARRAY HCG)
{
    ulong	net;
...
void
DumpHCG(nodeHCGType * YACR_ARRAY HCG)
{
    ulong	net;
    ulong	which;
...
void
NoHCV(nodeHCGType * YACR_ARRAY HCG,
      ulong select,
      ulong * YACR_ARRAY netsAssign,
      ulong * NONNULL COUNT(channelTracks+2) tracksNoHCV)
{
    ulong	track;
    ulong	net;
    ulong	which;
