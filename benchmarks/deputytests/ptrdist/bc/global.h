...
EXTERN bc_function * COUNT(f_count) functions;
EXTERN char * NTS * COUNT(f_count) f_names; 
#pragma cilnoremove("f_count")
EXTERN int  f_count;

/* Variable stoarge and reverse names. */

EXTERN bc_var * * COUNT(v_count) variables; 
EXTERN char * NTS * COUNT(v_count) v_names; 
EXTERN int  v_count;

/* Array Variable storage and reverse names. */

EXTERN bc_var_array * * COUNT(a_count) arrays;
EXTERN char * NTS * COUNT(a_count) a_names; 
EXTERN int  a_count;
...
EXTERN char * NTS * COUNT(g_argc) g_argv;
#pragma cilnoremove("g_argc");
EXTERN int    g_argc;
