...
more_functions (void)
{
  ...
  f_names = NULL;
  f_count += STORE_INCR;
  functions = (bc_function *)malloc(f_count*sizeof (* functions /* bc_function*/));
  f_names = (char * NTS *)malloc(f_count*sizeof (* f_names /* char * */));
...
more_variables (void)
{
  ...
  v_names = NULL;
  v_count += STORE_INCR;
  variables = (bc_var * *)malloc(v_count*sizeof(* variables /* bc_var **/));
  v_names = (char * NTS *)malloc(v_count*sizeof(* v_names /* char * */));
...
more_arrays (void)
{
  ...
  a_names = NULL;
  a_count += STORE_INCR;
  arrays = (bc_var_array * *)malloc(a_count*sizeof(* arrays /* bc_var_array **/));
  a_names = (char * NTS *)malloc(a_count*sizeof(* a_names /*char * */));
...
get_array_num (int var_index, long index)
{
  ...
  if (ary_ptr == NULL)
    {
      ary_ptr = arrays[var_index] = (bc_var_array *)malloc(sizeof (* ary_ptr /*bc_var_array*/));
  ...
  if (a_var == NULL) {
    a_var = ary_ptr->a_value = (bc_array *)malloc(sizeof (* a_var /*bc_array*/));
    a_var->a_tree = NULL;
    a_var->a_depth = 0;
  }
  ...
  while (log > a_var->a_depth)
    {
      temp = (bc_array_node *)malloc(sizeof(* temp /*bc_array_node*/));
      if (a_var->a_depth != 0)
	{
  ...
  while ( log-- > 1)
	...
	{
	  temp->n_down[ix1] = (bc_array_node *)malloc(sizeof(*temp->n_down[0]/*bc_array_node*/));
...
auto_var (int name)
{
  ...
  if (name > 0)
  ...
  else
    {
      /* An array variable. */
      ix = -name;
      a_temp = (bc_var_array *)malloc(sizeof (*a_temp/*bc_var_array*/));
	  ...
	  if ((ch == '0') && params->av_name > 0) 
	    {
	      /* A simple variable. */
	      ix = params->av_name;
	      v_temp = (bc_var *)malloc(sizeof(*v_temp/*bc_var*/));
	      v_temp->v_next = variables[ix];
