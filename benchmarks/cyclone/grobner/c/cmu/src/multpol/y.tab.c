...
case 2:
# line 10 "translate.y"
{status=1;return;} break;
case 3:
# line 11 "translate.y"
{status=2;return;} break;
case 4:
# line 12 "translate.y"
{status=4;return;} break;
case 6:
# line 17 "translate.y"
{
...
# line 45 "translate.y"
{
				...
				free(numbers[yypvt[-2]]);numbers[yypvt[-2]]=NULL;
				mpolmonmove(&coef,expo,&tempmon);
				clean1();
			} break;
case 14:
...
# line 61 "translate.y"
{
				...
				free(numbers[yypvt[-0]]);numbers[yypvt[-0]]=NULL;
				mpolmonmove(&coef,expo,&tempmon);
				clean1();
			} break;
case 19:
