...
expoequal(short int *exp1, short int *exp2)
{
	register i;
...
expodiv(short int *exp1, short int *exp2)
{
  register i;
...
expostrictdiv(short int *exp1, short int *exp2)
{
  register i;
...
expocrit2(short int *exp1, short int *exp2)
{
  register i;
