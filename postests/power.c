...
double find_g(void) ;
double find_h(void) ;
double find_gradient_f(double pi_R , double pi_I , double * __attribute__ ((array)) gradient ) ;
double find_gradient_g(double * __attribute__ ((array)) gradient ) ;
double find_gradient_h(double * __attribute__ ((array)) gradient ) ;
void find_dd_grad_f(double pi_R , double pi_I , double * __attribute__ ((array)) dd_grad ) ;
double make_orthogonal(double *  __attribute__ ((array)) v_mod , double *v_static ) ;
void Compute_Tree(Root r ) 
{ register int i ;
  Lateral l ;
  Demand *a ;
