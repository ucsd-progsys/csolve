 ...
 * ------------------------------------------------------------------------
 *
 * $Id: ft.c 8205 2006-05-30 19:23:56Z necula $
 *
 */

#include <limits.h>
#include <stdio.h>
//#include <stdlib.h>     // sm: avoid conflicts with random
#include "proto.h"        // my replacement
#include <assert.h>
...
int      // sm: changed from void to silence warning
main(int argc, char * NT * NT COUNT(argc) argv)
{
  int            nVertex;
  int            nEdge;
  Vertices *  graph;
