AddEdges ::
  ...
  store_in  [A0 |-> 0: int (4, true, {v | true}), 4[4]: ref (A1, true, {v | true}); A1 |-> true: ref (A1, true, {v | true})]
  store_out [A0 |-> 0: int (4, true, {v | true}), 4[4]: ref (A1, true, {v | true}); A1 |-> true: ref (A1, true, {v | true})]
...
ComputeMst ::
  forall    [A0; A1]
  arg       (graph: ref (A0, 0, {v | true}), numvert: int (4, true, {v | true}))
  ret       int (0, true, {v | true})
  store_in  [A0 |-> 0: int (4, true, {v | true}), 4[4]: ref (A1, true, {v | true}); A1 |-> true: ref (A1, true, {v | true})]
  store_out [A0 |-> 0: int (4, true, {v | true}), 4[4]: ref (A1, true, {v | true}); A1 |-> true: ref (A1, true, {v | true})]
