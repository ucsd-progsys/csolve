...
#else
// csolve doesn't understand void * yet?  investigate
typedef int       *gpointer;
typedef const int *gconstpointer;
#endif
...
#else
typedef gconstpointer GCompareFunc;
typedef gconstpointer GCompareDataFunc;
typedef gconstpointer GEqualFunc;
typedef gconstpointer GDestroyNotify;
typedef gconstpointer GFunc;
typedef gconstpointer GHashFunc;
typedef gconstpointer GHashFunc;
typedef gconstpointer GFreeFunc;
#endif
