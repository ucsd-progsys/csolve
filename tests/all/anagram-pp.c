# 1 "../ptrdist/anagram/anagram.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../ptrdist/anagram/anagram.c"
# 131 "../ptrdist/anagram/anagram.c"
...
# 132 "../ptrdist/anagram/anagram.c" 2
...
# 133 "../ptrdist/anagram/anagram.c" 2
...
# 134 "../ptrdist/anagram/anagram.c" 2
...
# 136 "../ptrdist/anagram/anagram.c" 2
...
# 137 "../ptrdist/anagram/anagram.c" 2
# 149 "../ptrdist/anagram/anagram.c"
typedef unsigned long Quad;
# 200 "../ptrdist/anagram/anagram.c"
typedef struct {
    Quad aqMask[2];
    char * pchWord;
    unsigned cchLength;
...
int main(int cpchArgc, char **ppchArgv) {
    ...
    while (GetPhrase(&achPhrase[0]) != ((void *)0)) {
