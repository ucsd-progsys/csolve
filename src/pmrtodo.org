...
** Try super-deep initializers (two, three levels of structure)
...
** Keep an eye on extern inits
   ...
   We're already insisting that global externs get initializers. We
   should also track down their reachable locations and ensure those
   all have constraints.

** Check that heapified globals are still getting initialized correctly
