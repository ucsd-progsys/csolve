...
* TODO Update coreutils programs to new specs

* TODO Add working coreutils programs to regression tests
...
* TODO Add TODO list for things to check when adding an extern spec
* TODO Take a hard look at functions like gettext
