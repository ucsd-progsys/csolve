...
** TODO Slocs in parsing and shape inference error messages
   They may have nothing to do with the slocs that the user actually
   wrote down in the specs. Keep a "displayname" attribute for slocs?
