...
* TODO Arrays at ends of structs get right indices?

* TODO Better error message when can't parse predicate
  Right now it just seems to dump an empty spec

* TODO Better error messages overall

* TODO Include liquidc/src/include (or really include32) as default include dir

* TODO Deferred checks
  See also indices above

* TODO Change add_and_fold_overlap to add_field_fold_overlap
