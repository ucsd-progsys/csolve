...
val infer_fun_indices : Ctypes.cfun CilMisc.VarMap.t -> Ssa_transform.ssaCfgInfo CilMisc.VarMap.t -> Ctypes.cfun -> Ssa_transform.ssaCfgInfo -> Ctypes.ctype CilMisc.VarMap.t * dcheck list
