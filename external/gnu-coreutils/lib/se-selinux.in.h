...
static inline int getcon (security_context_t NNSTRINGPTR START * con _GL_UNUSED_PARAMETER)
  { errno = ENOTSUP; return -1; }
static inline void freecon (security_context_t STRINGPTR START con _GL_UNUSED_PARAMETER) {}


static inline int getfscreatecon (security_context_t *con _GL_UNUSED_PARAMETER)
  { errno = ENOTSUP; return -1; }
static inline int setfscreatecon (security_context_t STRINGPTR con _GL_UNUSED_PARAMETER)
  { errno = ENOTSUP; return -1; }
static inline int matchpathcon (char const *file _GL_UNUSED_PARAMETER,
  ...
  { errno = ENOTSUP; return -1; }
static inline int getfilecon (char const * STRINGPTR file _GL_UNUSED_PARAMETER,
                              security_context_t NNSTRINGPTR START *con _GL_UNUSED_PARAMETER)
  { errno = ENOTSUP; return -1; }
...
static inline int security_check_context
    (security_context_t STRINGPTR con _GL_UNUSED_PARAMETER)
  { errno = ENOTSUP; return -1; }
static inline int security_check_context_raw
    (security_context_t con _GL_UNUSED_PARAMETER)
  { errno = ENOTSUP; return -1; }
static inline int setexeccon (security_context_t STRINGPTR con _GL_UNUSED_PARAMETER)
  { errno = ENOTSUP; return -1; }
static inline int security_compute_create
    (security_context_t STRINGPTR scon _GL_UNUSED_PARAMETER,
     security_context_t STRINGPTR tcon _GL_UNUSED_PARAMETER,
     security_class_t tclass _GL_UNUSED_PARAMETER,
     security_context_t NNSTRINGPTR START *newcon _GL_UNUSED_PARAMETER)
  { errno = ENOTSUP; return -1; }
