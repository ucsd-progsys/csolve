...
static inline context_t context_new (char const * STRINGPTR s _GL_UNUSED_PARAMETER)
  { errno = ENOTSUP; return 0; }
static inline char * NNSTRINGPTR context_str (context_t con _GL_UNUSED_PARAMETER)
...
static inline int context_user_set (context_t sc _GL_UNUSED_PARAMETER,
                                    char const * STRINGPTR s _GL_UNUSED_PARAMETER)
