...
extern void * LOC(!L) START NONNULL SIZE(__size)
     xmalloc (size_t REF(V >= 0) __size) 
  ATTRIBUTE_MALLOC ATTRIBUTE_ALLOC_SIZE ((1)) OKEXTERN;
...
char * ARRAY VALIDPTR
  xstrdup (char const * ARRAY VALIDPTR str)
    ATTRIBUTE_MALLOC OKEXTERN;
...
# else
void * LOC(!L) START NONNULL xnmalloc (size_t n, size_t s)
       ATTRIBUTE_MALLOC ATTRIBUTE_ALLOC_SIZE ((1, 2)) OKEXTERN;
void * xnrealloc (void *p, size_t n, size_t s)
      ATTRIBUTE_ALLOC_SIZE ((2, 3));
void * LOC(!L) START NONNULL SIZE_GE((DEREF([pn]) : int)) x2nrealloc (void * NNVALIDPTR p,
								      size_t REF(V > 0) * VALIDPTR pn,
								      size_t REF(V > 0) s) OKEXTERN;
