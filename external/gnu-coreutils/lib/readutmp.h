...
int read_utmp (char const NULLTERMSTR * ARRAY VALIDPTR file, size_t * n_entries, STRUCT_UTMP * NNROOM_FOR(STRUCT_UTMP) * ARRAY NNVALIDPTR utmp_buf,
               int options) OKEXTERN;

int csolve_read_utmp (char const NULLTERMSTR * ARRAY VALIDPTR file, size_t * n_entries,
    STRUCT_UTMP * VALIDPTR * ARRAY NNVALIDPTR SIZE(n_entries * sizeof(STRUCT_UTMP *)) * NNROOM_FOR(STRUCT_UTMP *) utmp_buf) OKEXTERN;
