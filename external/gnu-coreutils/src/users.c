...
static int
userid_compare (const void * VALIDPTR START LAYOUT(char *) v_a, const void * VALIDPTR START LAYOUT(char *) v_b)
{
  char **a = (char **) v_a;
  char **b = (char **) v_b;
  return strcmp (*a, *b);
...
static void
list_entries_users (size_t n, const STRUCT_UTMP * START ARRAY VALIDPTR this)
{
...
static void
users (const char *STRINGPTR filename, int options)
{
  size_t n_users;
