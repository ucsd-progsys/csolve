  ...
  CHECK_TYPE GLOBAL(PROGRAM_NAME_LOC)
{
  ...
  while (1)
    {
      ...
      /* abakst: this is not good...there should be a note in done
	 because this does not really count as *done* */
      ...
      switch (c)
        ...
        case IGNORE_OPTION:
          // pmr: How to know optarg is non-null here?
	  CSOLVE_ASSUME(optarg != 0)
  ...
  // ABAKST I guess csolve doesn't like the fact that exit doen't return
  return 0;
}
