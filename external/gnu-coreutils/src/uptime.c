...
static void
print_uptime (size_t n, const STRUCT_UTMP * ARRAY this)
{
  size_t entries = 0;
  time_t boot_time = 0;
  time_t time_now;
...
static void
uptime (const char NULLTERMSTR * ARRAY VALIDPTR filename, int options)
{
  size_t n_users;
...
int main(int REF(V > 0) argc, char NULLTERMSTR * ARRAY VALIDPTR LOC(PROGRAM_NAME_LOC) * START ARRAY NONNULL SIZE(argc * 4) argv)
