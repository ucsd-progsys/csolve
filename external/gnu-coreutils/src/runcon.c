  ...
  CHECK_TYPE GLOBAL(PROGRAM_NAME_LOC)
{
  ...
  if (argc - optind == 0)
    {
      /* ABAKST not sure what we want to do about this. This seems to
	 use a dummy implementation of selinux, with implementation in
	 the header that always returns -1. */
