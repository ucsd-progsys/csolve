// pmr: Need better handling of read-only aliases
...
// pmr: Manually hoisted. Need better aliasing handling.
static char NULLTERMSTR const * LOC(PROGRAM_NAME_LOC) dot = ".";
...
{
  // pmr: Have to move dot so we could alias &dot with PROGRAM_NAME_LOC
