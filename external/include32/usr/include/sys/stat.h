...
extern __mode_t umask (__mode_t __mask) __THROW OKEXTERN;
...
extern int mknod (__const char FINAL NULLTERMSTR * STRINGPTR __path, __mode_t __mode, __dev_t __dev)
...
extern int mkfifo (__const char FINAL NULLTERMSTR * STRINGPTR __path, __mode_t __mode)
     __THROW __nonnull ((1)) OKEXTERN;
