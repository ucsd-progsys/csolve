...
extern int getpriority (__priority_which_t __which, id_t __who) __THROW OKEXTERN;

/* Set the priority of all processes specified by WHICH and WHO (see above)
   to PRIO.  Returns 0 on success, -1 on errors.  */
extern int REF(|| [V = 0; V = (-1)])
setpriority (__priority_which_t __which, id_t __who, int __prio)
  __THROW OKEXTERN;
