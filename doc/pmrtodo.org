...
* DONE Check indices using inferred predicates
  Be sure to make sure negtests are failing for the right reasons
  (comment out index checks, or flag, test, uncomment).
